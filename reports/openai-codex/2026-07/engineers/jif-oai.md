...
- PRs opened: **29**
- PRs merged: **18**
- Of those, substantive (excluding dependency, config, docs): **18**
...
- Reviews given: **18** across **8** other authors
- Median time from PR open to your review: **21.08** h

## Rework

- PRs that received a changes-requested review: **0** of 18 measured
- Reverts authored: **0**
