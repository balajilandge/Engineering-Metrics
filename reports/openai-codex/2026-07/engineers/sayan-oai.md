...
- PRs opened: **6**
- PRs merged: **6**
- Of those, substantive (excluding dependency, config, docs): **6**
...
- Reviews given: **16** across **7** other authors
- Median time from PR open to your review: **16.91** h

## Rework

- PRs that received a changes-requested review: **1** of 6 measured
- Reverts authored: **0**
