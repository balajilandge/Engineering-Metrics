...
- PRs opened: **14**
- PRs merged: **5**
- Of those, substantive (excluding dependency, config, docs): **5**
...
- Reviews given: **24** across **10** other authors
- Median time from PR open to your review: **23.54** h

## Rework

- PRs that received a changes-requested review: **0** of 5 measured
- Reverts authored: **0**
