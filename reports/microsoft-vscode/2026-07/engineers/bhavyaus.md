...
- PRs opened: **22**
- PRs merged: **16**
- Of those, substantive (excluding dependency, config, docs): **16**
...
- Reviews given: **12** across **8** other authors
- Median time from PR open to your review: **1.14** h

## Rework

- PRs that received a changes-requested review: **0** of 8 measured
- Reverts authored: **1**
