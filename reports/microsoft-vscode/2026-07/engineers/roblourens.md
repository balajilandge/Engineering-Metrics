...
- PRs opened: **134**
- PRs merged: **123**
- Of those, substantive (excluding dependency, config, docs): **116**
...
- Reviews given: **89** across **28** other authors
- Median time from PR open to your review: **1.32** h

## Rework

- PRs that received a changes-requested review: **0** of 44 measured
- Reverts authored: **3**
