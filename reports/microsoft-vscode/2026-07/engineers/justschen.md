...
- PRs opened: **59**
- PRs merged: **52**
- Of those, substantive (excluding dependency, config, docs): **52**
...
- Reviews given: **27** across **14** other authors
- Median time from PR open to your review: **1.26** h

## Rework

- PRs that received a changes-requested review: **0** of 19 measured
- Reverts authored: **1**
