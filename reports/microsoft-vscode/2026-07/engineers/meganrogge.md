...
- PRs opened: **117**
- PRs merged: **92**
- Of those, substantive (excluding dependency, config, docs): **92**
...
- Reviews given: **33** across **9** other authors
- Median time from PR open to your review: **2.13** h

## Rework

- PRs that received a changes-requested review: **0** of 28 measured
- Reverts authored: **0**
