...
- PRs opened: **86**
- PRs merged: **65**
- Of those, substantive (excluding dependency, config, docs): **65**
...
- Reviews given: **13** across **6** other authors
- Median time from PR open to your review: **0.51** h

## Rework

- PRs that received a changes-requested review: **0** of 23 measured
- Reverts authored: **0**
