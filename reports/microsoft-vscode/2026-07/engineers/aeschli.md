...
- PRs opened: **28**
- PRs merged: **26**
- Of those, substantive (excluding dependency, config, docs): **26**
...
- Reviews given: **13** across **8** other authors
- Median time from PR open to your review: **0.48** h

## Rework

- PRs that received a changes-requested review: **0** of 3 measured
- Reverts authored: **2**
