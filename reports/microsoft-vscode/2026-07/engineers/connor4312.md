...
- PRs opened: **82**
- PRs merged: **77**
- Of those, substantive (excluding dependency, config, docs): **77**
...
- Reviews given: **6** across **6** other authors
- Median time from PR open to your review: **21.24** h

## Rework

- PRs that received a changes-requested review: **0** of 32 measured
- Reverts authored: **0**
