...
- PRs opened: **15**
- PRs merged: **13**
- Of those, substantive (excluding dependency, config, docs): **13**
...
- Reviews given: **6** across **5** other authors
- Median time from PR open to your review: **20.91** h

## Rework

- PRs that received a changes-requested review: **0** of 4 measured
- Reverts authored: **0**
