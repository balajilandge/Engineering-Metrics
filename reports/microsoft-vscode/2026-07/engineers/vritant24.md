...
- PRs opened: **34**
- PRs merged: **33**
- Of those, substantive (excluding dependency, config, docs): **33**
...
- Reviews given: **19** across **12** other authors
- Median time from PR open to your review: **1.3** h

## Rework

- PRs that received a changes-requested review: **0** of 11 measured
- Reverts authored: **0**
