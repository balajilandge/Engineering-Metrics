...
- PRs opened: **34**
- PRs merged: **31**
- Of those, substantive (excluding dependency, config, docs): **30**
...
- Reviews given: **47** across **21** other authors
- Median time from PR open to your review: **2.26** h

## Rework

- PRs that received a changes-requested review: **0** of 14 measured
- Reverts authored: **0**
