...
- PRs opened: **108**
- PRs merged: **106**
- Of those, substantive (excluding dependency, config, docs): **105**
...
- Reviews given: **33** across **15** other authors
- Median time from PR open to your review: **0.74** h

## Rework

- PRs that received a changes-requested review: **0** of 46 measured
- Reverts authored: **0**
...
_Not generated: interpretation was switched off for this run, so this page is the deterministic numbers only._
